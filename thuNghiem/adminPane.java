...
public class adminPane extends JFrame {
	...
	public adminPane(String userName) {
		...
		mntmNewMenuItem_1.addActionListener(new ActionListener() {
			...
			int a =JOptionPane.showConfirmDialog(lblLoi,"Chắc chắn đăng xuất?");
		...
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\sondu\\Downloads\\r1.png"));
		...
		lblNewLabel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				lblNewLabel.setComponentPopupMenu(popupMenu);
			}
		});
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\sondu\\Downloads\\levels.png"));
		lblNewLabel.setBounds(143, 112, 16, 16);
		panel.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\sondu\\Downloads\\google-panda-circular-symbol.png"));
		...
		lblQLKH.setIcon(new ImageIcon("C:\\Users\\sondu\\Downloads\\user.png"));
		...
		lblTK.setIcon(new ImageIcon("C:\\Users\\sondu\\Downloads\\file.png"));
		...
		lblQLMT.setIcon(new ImageIcon("C:\\Users\\sondu\\Downloads\\computer (4).png"));
